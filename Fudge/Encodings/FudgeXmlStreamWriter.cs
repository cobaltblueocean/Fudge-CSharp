...
namespace Fudge.Encodings
{
    ...
    public class FudgeXmlStreamWriter : IFudgeStreamWriter
    {
        ...
        void IFudgeStreamWriter.StartMessage()
        {
            throw new NotImplementedException();
        }

        void IFudgeStreamWriter.StartSubMessage(string name, int? ordinal)
        {
            throw new NotImplementedException();
        }

        void IFudgeStreamWriter.WriteField(string name, int? ordinal, FudgeFieldType type, object value)
        {
            throw new NotImplementedException();
        }

        void IFudgeStreamWriter.WriteFields(IEnumerable<IFudgeField> fields)
        {
            throw new NotImplementedException();
        }

        void IFudgeStreamWriter.EndSubMessage()
        {
            throw new NotImplementedException();
        }

        void IFudgeStreamWriter.EndMessage()
        {
            throw new NotImplementedException();
        }

        FudgeContext IFudgeStreamWriter.FudgeContext
        {
            get { throw new NotImplementedException(); }
        }

        Taxon.IFudgeTaxonomy IFudgeStreamWriter.CurrentTaxonomy
        {
            get { throw new NotImplementedException(); }
        }

        int IFudgeStreamWriter.CurrentTaxonomyId
        {
            get
            {
                throw new NotImplementedException();
        ...
        void IFudgeStreamWriter.WriteEnvelopeHeader(int processingDirectives, int schemaVersion, int messageSize)
        {
            throw new NotImplementedException();
        }

        void IFudgeStreamWriter.EnvelopeComplete()
        {
            throw new NotImplementedException();
        }

        void IFudgeStreamWriter.WriteField(IFudgeField field)
        {
            throw new NotImplementedException();
        }

        void IFudgeStreamWriter.WriteField(short ordinal, string name, FudgeFieldType type, object fieldValue)
        {
            throw new NotImplementedException();
        }

        void IFudgeStreamWriter.WriteFields(IFudgeFieldContainer fields)
        {
            throw new NotImplementedException();
        }

        void IFudgeStreamWriter.Flush()
        {
            throw new NotImplementedException();
        }

        void IFudgeStreamWriter.Close()
        {
            throw new NotImplementedException();
        }
    }
