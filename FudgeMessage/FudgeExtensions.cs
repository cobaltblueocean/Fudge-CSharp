...
namespace FudgeMessage
{
    ...
    public static class FudgeExtensions
    {
        ...
        /// <param name="value">Value to add.</param>
        public static void AddIfNotNull(this IAppendingFudgeFieldContainer msg, short? ordinal, object value)
        {
            if (value != null)
            {
        ...
        /// <param name="values">Values to write.</param>
        /// <remarks><c>null</c>s in the sequence are written as Fudge <see cref="IndicatorType"/>s.</remarks>
        public static void AddAll<T>(this IAppendingFudgeFieldContainer msg, short? ordinal, IEnumerable<T> values)
        {
        ...
        /// <param name="values">Values to write.</param>
        /// <remarks><c>null</c>s in the sequence are written as Fudge <see cref="IndicatorType"/>s.</remarks>
        public static void AddAll<T>(this IAppendingFudgeFieldContainer msg, string name, short? ordinal, IEnumerable<T> values)
        {
