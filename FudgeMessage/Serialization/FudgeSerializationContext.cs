...
namespace FudgeMessage.Serialization
{
    ...
    public class FudgeSerializationContext : IFudgeSerializer, IFudgeMessageFactory
    {
        ...
        /// <inheritdoc/>
        public void WriteInline(IAppendingFudgeFieldContainer msg, string fieldName, short? ordinal, object obj)
        {
            if (obj != null)
            {
        ...
        private void Write(string fieldName, short? ordinal, FudgeFieldType type, object value)
        {            
            if (type == null)
            {
        ...
        private void WriteObject(string fieldName, short? ordinal, object value, bool allowRefs, bool writeTypeInfo)
        {
            if (allowRefs)
            {
        ...
        private sealed class StreamingMessage : IAppendingFudgeFieldContainer
        {
            ...
            public void Add(string name, short? ordinal, FudgeFieldType type, object value)
            {
