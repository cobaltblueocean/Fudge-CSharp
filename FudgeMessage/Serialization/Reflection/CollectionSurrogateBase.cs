...
namespace FudgeMessage.Serialization.Reflection
{
    /// <summary>
    ...
    public abstract class CollectionSurrogateBase : IFudgeSerializationSurrogate
    {
        ...
        protected static void SerializeList<T>(IEnumerable<T> list, IAppendingFudgeFieldContainer msg, IFudgeSerializer serializer, TypeData.TypeKind kind, short? ordinal)
        {
            switch (kind)
            {
