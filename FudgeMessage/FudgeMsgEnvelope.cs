...
namespace FudgeMessage
{
    ...
    public class FudgeMsgEnvelope : FudgeEncodingObject
    {
        ...
        public FudgeMsgEnvelope(FudgeMsg msg, int version)
            : this(msg, version, 0)
        {
        }
        ...
        /// <param name="version">schema version, 0 to 255</param>
        /// <param name="processingDirectives">Creates an envelope wrapping the given message with a version and processing directive flags, 0 to 255</param>
        ...
        {
            get { return _processingDirectives; }
        }
