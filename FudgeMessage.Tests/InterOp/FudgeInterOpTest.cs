...
namespace FudgeMessage.Tests.Unit
{
    ...
    public class FudgeInterOpTest
    {
        ...
        protected static FudgeMsg CycleMessage(FudgeMsg msg, string filename) //throws IOException
        {
            ...
            Stream stream = assembly.GetManifestResourceStream("FudgeMessage.Tests.Resources." + filename);
            ...
            stream = assembly.GetManifestResourceStream("FudgeMessage.Tests.Resources." + filename);
